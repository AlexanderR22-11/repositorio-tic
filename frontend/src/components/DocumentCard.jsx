...
export default function DocumentCard({ doc }) {
  return (
    <article className="bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-xl transition transform hover:-translate-y-1">
      ...
      <div className="p-5">
        ...
        <div className="mt-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <a
              href={doc.url}
              className="inline-flex items-center gap-2 text-sm font-medium text-white bg-[#006847] hover:bg-[#005c3f] px-3 py-2 rounded-lg"
