  ...
  return (
    <div className="min-h-screen bg-base-200">
      ...
      >
            ...
            <div className="flex flex-col md:flex-row gap-3">
              <label className="input input-bordered w-full flex items-center gap-2">
                ...
                <input
                  ...
                  placeholder="Buscar por título, tipo o materia"
                />
              </label>
        ...
        {status === "success" ? (
          <div className="alert alert-success mb-4">Acción realizada correctamente.</div>
        ) : null}
              ...
              <article key={m.id} className="card bg-base-100 shadow border border-base-200">
                ...
                <div className="card-body p-4">
                  ...
                  <p className="text-xs text-base-content/60">
                    Publicado: {new Date(m.fecha).toLocaleDateString()}
                  </p>
